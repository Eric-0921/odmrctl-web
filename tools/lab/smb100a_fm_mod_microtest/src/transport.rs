//! TCP transport and audited command helpers for the M3.1 FM/MOD micro-test tool.

use crate::safety::{
    classify_command_for_audit, is_safety_relevant, validate_microtest_set_command,
    validate_smb_query_only,
};
