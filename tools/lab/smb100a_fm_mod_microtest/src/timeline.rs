//! Timeline tracking and wall-clock helpers for the M3.1 FM/MOD micro-test tool.

use crate::types::TimelineEvent;
use odmr_logging::{EventLevel, RunEvent, RunEventType};
...
pub fn wall_time_utc_iso() -> String {
