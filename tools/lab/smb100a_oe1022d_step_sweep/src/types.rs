...
/// M3.2 sweep configuration, written as metadata/step_sweep_config.json
...
/// Maps an OE1022D frame to the RF step it was acquired during.
#[derive(Serialize, Deserialize, Debug, Clone)]
...
// ---------------------------------------------------------------------------
// Reused/adapted from M3.1 types
// ---------------------------------------------------------------------------
...
pub struct StationSnapshotQuality {
    pub schema_version: String,
    pub status: String,
    pub eligible_for_step_sweep: bool,
    pub warnings: Vec<String>,
    pub errors: Vec<String>,
...
pub struct HashManifest {
    pub schema_version: String,
    pub step_sweep_config_hash: String,
