...
#[command(name = "smb100a-oe1022d-step-sweep")]
#[command(about = "M3.2: SMB100A software-stepped RF sweep + OE1022D passive acquisition")]
pub struct Cli {
    // --- SMB100A ---
    ...
    // --- RF sweep ---
    #[arg(long, default_value = "2880000000")]
    pub rf_start_hz: f64,

    #[arg(long, default_value = "2884000000")]
    pub rf_stop_hz: f64,
    ...
    // --- Safety ---
    /// Operator explicitly approves the step-sweep with FM/MOD/RF output.
    #[arg(long)]
    pub operator_approves_step_sweep: bool,
